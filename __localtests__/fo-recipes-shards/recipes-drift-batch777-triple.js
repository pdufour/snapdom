/**
 * Drift batch 777 — tc-fix-drift-039 lh-normal × 555 winner stacks (drift-batch777-001..040).
 * Lane theme: line-height:normal!important on every 555 stack (001–030 grid + 031–040 wf forks).
...
const SPECS = [
  ...
  },
  {
    ...
    extra: {
      inject: 'both',
      css: H2_RASTER_NORMALIZE_CSS + CAPTURE_LH_NORMAL_IMPORTANT,
      harnessSnapdom: { embedFonts: true, experimentalFoTextLineHeightNormal: true },
      rasterPatch: 'lab-toCanvas',
      svgRootRound: 'integer-viewbox',
      labToCanvasOpts: { ...W7_META },
    },
...
const RECIPES = SPECS.map((spec, i) => {
  ...
  return {
    ...
    notes: `Drift batch 777 lane=${spec.lane}; SVG root + decode triple-alignment; FO raster only.`,
    ...restExtra,
  }
})
