...
5. Between recipes **{{RECIPE_A}}** and **{{RECIPE_B}}** (and any others shown): which **canvas** is closest to **live**? Which fix would you promote to `src/` only if headed re-check agrees?
